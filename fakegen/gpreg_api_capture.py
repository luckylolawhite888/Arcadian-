...
1. Bypasses the landing page WAF via 2Captcha
2. Navigates to the form
3. Captures ALL network requests (API endpoints, payloads, headers)
4. Saves them to /tmp for analysis
"""
import os
...
const TWOCAPTCHA_KEY = "''' + TWOCAPTCHA_KEY + r'''";
...
def main():
    with open('/home/node/.openclaw/workspace/fakegen/gpreg_api_capture.js', 'w') as f:
        f.write(JS)
    print('Generated: gpreg_api_capture.js')
