...
class MonzoOAuth:
    def __init__(self):
        # Your Lola client credentials
        self.client_id = "oauth2client_0000B4gx70WqERHeos1pdi"
        self.client_secret = "mnzconf.h86Lol99GhXuqdcaha+3N1+4fkj+qL4CP76LiSXOofCws+ZNxE79uz9tKyyAbZmOQbeDqLzbk45NV3ETpPNq9A=="
