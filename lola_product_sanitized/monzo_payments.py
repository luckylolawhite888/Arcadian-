...
class "YOUR_API_KEY_HERE":
    ...
    def load_credentials(self):
        ...
        try:
            with open("/path/to/your/workspace", "r") as f:
    ...
    def "YOUR_API_KEY_HERE"(self, amount, description, recipient_type="pot", recipient_id=None):
    ...
    def "YOUR_API_KEY_HERE"(self, request):
    ...
    def execute_payment(self, payment_id):
        ...
        for payment in self.payment_log:
            if payment["payment_id"] == payment_id and payment["status"] == "approved" and not payment["executed"]:
                ...
                with open("/path/to/your/workspace", "a") as f:
    ...
    def save_log(self):
        ...
        try:
            with open("/path/to/your/workspace", "w") as f:
...
if __name__ == "__main__":
    ...
    request = approval."YOUR_API_KEY_HERE"(
        amount=50.00,
        description="Move to Savings Pot",
        recipient_type="pot",
        recipient_id="YOUR_POT_ID_HERE"
    )
    
    if request:
        message, buttons = approval."YOUR_API_KEY_HERE"(request)
